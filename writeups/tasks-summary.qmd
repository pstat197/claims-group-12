...
Including the header improved our predictions by almost 2% accuracy. Before the header was included, our neural network model had a binary classification accuracy of 0.75, and after including the headers, the model's binary classification accuracy was 0.77.
...
-   training epochs: We kept the number of training epochs at 5.
